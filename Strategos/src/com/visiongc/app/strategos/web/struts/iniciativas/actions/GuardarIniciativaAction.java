...
public class GuardarIniciativaAction extends VgcAction
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		if (cancelar)
		{
			strategosIniciativasService.unlockObject(request.getSession().getId(), editarIniciativaForm.getIniciativaId());
		...
		if ((editarIniciativaForm.getIniciativaId() != null) && (!editarIniciativaForm.getIniciativaId().equals(Long.valueOf("0"))))
			iniciativa = (Iniciativa)strategosIniciativasService.load(Iniciativa.class, editarIniciativaForm.getIniciativaId());
		else
		{
			nuevo = true;
		...
		if ((editarIniciativaForm.getAnioFormulacion() != null) && (!editarIniciativaForm.getAnioFormulacion().equals("")))
		...
		if((editarIniciativaForm.getResponsableProyecto() != null) && (editarIniciativaForm.getResponsableProyecto() != "")) 
			iniciativa.setResponsableProyecto(editarIniciativaForm.getResponsableProyecto());
		else
			iniciativa.setResponsableProyecto(null);
					
		if((editarIniciativaForm.getCargoResponsable() != null) && (!editarIniciativaForm.getCargoResponsable().equals("")))
			iniciativa.setCargoResponsable(editarIniciativaForm.getCargoResponsable());
		else
			iniciativa.setCargoResponsable(null);
		
		if((editarIniciativaForm.getOrganizacionesInvolucradas() != null) && (!editarIniciativaForm.getOrganizacionesInvolucradas().equals("")))
		...
		if((editarIniciativaForm.getObjetivoEstrategico() != null) && (!editarIniciativaForm.getObjetivoEstrategico().equals("")))
			iniciativa.setObjetivoEstrategico(editarIniciativaForm.getObjetivoEstrategico());
		else
			iniciativa.setObjetivoEstrategico(null);
		
		if((editarIniciativaForm.getFuenteFinanciacion() != null) && (!editarIniciativaForm.getFuenteFinanciacion().equals("")))
			iniciativa.setFuenteFinanciacion(editarIniciativaForm.getFuenteFinanciacion());
		else
			iniciativa.setFuenteFinanciacion(null);
		
		if((editarIniciativaForm.getMontoFinanciamiento() != null) && (!editarIniciativaForm.getMontoFinanciamiento().equals("")))
			iniciativa.setMontoFinanciamiento(editarIniciativaForm.getMontoFinanciamiento());
		else
			iniciativa.setMontoFinanciamiento(null);
		
		if((editarIniciativaForm.getIniciativaEstrategica() != null) && (!editarIniciativaForm.getIniciativaEstrategica().equals("")))
		...
		if((editarIniciativaForm.getLiderIniciativa() != null) && (!editarIniciativaForm.getLiderIniciativa().equals("")))
			iniciativa.setLiderIniciativa(editarIniciativaForm.getLiderIniciativa());
		else
			iniciativa.setLiderIniciativa(null);
		
		if((editarIniciativaForm.getTipoIniciativa() != null) && (!editarIniciativaForm.getTipoIniciativa().equals("")))
			iniciativa.setTipoIniciativa(editarIniciativaForm.getTipoIniciativa());
		else
			iniciativa.setTipoIniciativa(null);
		
		if((editarIniciativaForm.getPoblacionBeneficiada() != null) && (!editarIniciativaForm.getPoblacionBeneficiada().equals("")))
		...
		if((editarIniciativaForm.getDefinicionProblema() != null) && (!editarIniciativaForm.getDefinicionProblema().equals("")))
		...
		if((editarIniciativaForm.getObjetivoGeneral() != null) && (!editarIniciativaForm.getObjetivoGeneral().equals("")))
			iniciativa.setObjetivoGeneral(editarIniciativaForm.getObjetivoGeneral());
		else
			iniciativa.setObjetivoGeneral(null);
		
		if((editarIniciativaForm.getObjetivoEspecificos() != null) && (!editarIniciativaForm.getObjetivoEspecificos().equals("")))
		...
		if (editarIniciativaForm.getAlertaZonaAmarilla() != null && editarIniciativaForm.getHayValorPorcentajeAmarillo())
		...
		Boolean cambioFrecuencia = (iniciativa != null && iniciativa.getFrecuencia() != null && iniciativa.getFrecuencia().byteValue() != editarIniciativaForm.getFrecuencia().byteValue());
		if (cambioFrecuencia)
		{
		...
		if ((editarIniciativaForm.getResultadoEspecificoIniciativa() != null) && (!editarIniciativaForm.getResultadoEspecificoIniciativa().equals("")))
		{
			String[] resultadosEspecificos = StringUtil.split(editarIniciativaForm.getResultadoEspecificoIniciativa(), editarIniciativaForm.getSEPARADOR());
			...
			for (int i = 0; i < resultadosEspecificos.length; i++) 
			{
				...
				if (!resultadoEspecifico.equals("")) 
				{
					...
					resultadoEspecificoIniciativa.setPk(new ResultadoEspecificoIniciativaPK(iniciativa.getIniciativaId(), new Integer(anoTemp)));
		...
		if ((editarIniciativaForm.getPerspectivaId() != null) && (editarIniciativaForm.getPerspectivaId().longValue() != 0L)) 
		{
		...
		if (selectEstatusType != null && !selectEstatusType.equals("") && !selectEstatusType.equals("0") && ((new Long(selectEstatusType)).longValue() == EstatusType.getEstatusCencelado().longValue() || (new Long(selectEstatusType)).longValue() == EstatusType.getEstatusSuspendido().longValue())) 
			iniciativa.setEstatusId(Long.parseLong(selectEstatusType));
		else if (selectEstatusType != null && !selectEstatusType.equals("") && !selectEstatusType.equals("0") && iniciativa.getEstatusId() != null && (iniciativa.getEstatusId().longValue() == EstatusType.getEstatusCencelado().longValue() || iniciativa.getEstatusId().longValue() == EstatusType.getEstatusSuspendido().longValue()))
		...
		{							
			...
			if (iniciativa.getEstatusId() != null && iniciativa.getEstatusId().longValue() != EstatusType.getEstatusCencelado().longValue() && iniciativa.getEstatusId().longValue() != EstatusType.getEstatusSuspendido().longValue() && editarIniciativaForm.getEliminarMediciones())
		...
		if (respuesta == VgcReturnCode.DB_OK)
			respuesta = actualizarActividades(cambioFrecuencia, iniciativa, getUsuarioConectado(request), strategosIniciativasService);
		...
		if (respuesta == VgcReturnCode.DB_OK) 
		{
			...
			if (nuevo)
			{
				...
				{
					Instrumentos instrumento = (Instrumentos)strategosInstrumentosService.load(Instrumentos.class, instrumentoId);
					if (instrumento != null)
						strategosInstrumentosService.asociarInstrumento(instrumentoId, iniciativa.getIniciativaId(), getUsuarioConectado(request));
					else 
	...
	public int actualizarActividades(Boolean cambioFrecuencia, Iniciativa iniciativa, Usuario usuario, StrategosIniciativasService strategosIniciativasService)
	{
		int respuesta = VgcReturnCode.DB_OK;;
		
		StrategosPryActividadesService strategosPryActividadesService = StrategosServiceFactory.getInstance().openStrategosPryActividadesService(strategosIniciativasService);
			...
			if (cambioFrecuencia)
			{
				...
				for (Iterator<PryActividad> iter = actividades.iterator(); iter.hasNext();) 
				{
				    ...
				    if (actividad.getIndicadorId() != null)
				        indicador = (Indicador)strategosIndicadoresService.load(Indicador.class, new Long(actividad.getIndicadorId()));
					if (respuesta == VgcReturnCode.DB_OK && indicador != null)
					{
						...
						if (respuesta == VgcReturnCode.DB_PK_AK_VIOLATED)
						{
							...
							List<Indicador> inds = strategosIndicadoresService.getIndicadores(0, 0, "nombre", "ASC", true, filtros, null, null, false).getLista();
							if (inds.size() > 0)
							{
		...
		if (respuesta == VgcReturnCode.DB_OK)
		{
			...
			for (Iterator<PryActividad> iter = actividades.iterator(); iter.hasNext();) 
			{
			    ...
			    if ((iniciativa.getMemoIniciativa() != null) && (iniciativa.getMemoIniciativa().getDescripcion() != null) && (!iniciativa.getMemoIniciativa().getDescripcion().equals("")))
			    ...
			    if (iniciativa.getResponsableFijarMetaId() != null && iniciativa.getResponsableFijarMetaId().equals(new Long(0L)))
			    	actividad.setResponsableFijarMetaId(null);
			    else 
			    	actividad.setResponsableFijarMetaId(iniciativa.getResponsableFijarMetaId());
			
			    if (iniciativa.getResponsableLograrMetaId() != null && iniciativa.getResponsableLograrMetaId().equals(new Long(0L)))
			    	actividad.setResponsableLograrMetaId(null);
			    else 
			    	actividad.setResponsableLograrMetaId(iniciativa.getResponsableLograrMetaId());
			
			    if (iniciativa.getResponsableSeguimientoId() != null && iniciativa.getResponsableSeguimientoId().equals(new Long(0L)))
			    	actividad.setResponsableSeguimientoId(null);
			    else 
			    	actividad.setResponsableSeguimientoId(iniciativa.getResponsableSeguimientoId());
			
			    if (iniciativa.getResponsableCargarMetaId() != null && iniciativa.getResponsableCargarMetaId().equals(new Long(0L)))
			    	actividad.setResponsableCargarMetaId(null);
			    else 
			    	actividad.setResponsableCargarMetaId(iniciativa.getResponsableCargarMetaId());
			
			    if (iniciativa.getResponsableCargarEjecutadoId() != null && iniciativa.getResponsableCargarEjecutadoId().equals(new Long(0L)))
			    ...
			    if (iniciativa.getIndicadorId(TipoFuncionIndicador.getTipoFuncionSeguimiento()) != null && iniciativa.getClaseId() != null)
			    {
			    	actividad.setIndicadorId(new Long(iniciativa.getIndicadorId(TipoFuncionIndicador.getTipoFuncionSeguimiento())));
		...
		if (respuesta == VgcReturnCode.DB_OK)
		{
			...
			for (Iterator<Long> iter = indicadores.iterator(); iter.hasNext();)
			{
				...
				if (indicadorId != null)
				{
					...
					{
						if (respuesta == VgcReturnCode.DB_OK)
							respuesta = strategosIndicadoresService.actualizarDatosIndicador(indicadorId, null, null, null);
					} 
					catch (Throwable e) 
					{
