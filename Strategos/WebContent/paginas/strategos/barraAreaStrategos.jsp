...
<script type="text/javascript">
	...
	function gestionarOrganizaciones() {
		...
		window.location.href = '<html:rewrite action="/organizaciones/gestionarOrganizaciones" />?defaultLoader=true&mostrarMisionVision='
				+ '<bean:write name="gestionarOrganizacionesForm" property="mostrarMisionVision" />';
		</logic:empty>
	...
	function gestionarPlan() {
		ajaxSendRequestReceiveInputSincronica(
				'GET',
				'<html:rewrite action="/planes/gestionarPlan" />?funcion=getPlanActivoId',
				document.barraAreaForm.planId, 'finalizarGestionarPlan()');
	}

	function finalizarGestionarPlan() {
		if ((document.barraAreaForm.planId.value == null)
				|| (document.barraAreaForm.planId.value == ''))
			...
			window.location.href = '<html:rewrite action="/planes/gestionarPlan" />?defaultLoader=true&planId='
					+ document.barraAreaForm.planId.value;
		else
			seleccionarPlan();
	}
	...
	function seleccionarPlan() {
		...
		abrirSelectorPlanes('barraAreaForm', 'nombrePlan', 'planId', '',
				'funcionCierreSelectorPlanes()', null, queryStringFiltros);
	}
	...
	function gestionarIniciativas() {
		...
		if (planActivoId != "")
			window.location.href = '<html:rewrite action="/iniciativas/gestionarIniciativasDePlan" />?defaultLoader=true&planId='
					+ planActivoId + '&source=Plan';
		else
	...
	function informesCualitativos() {
		...
		explicacion.ShowList(true,
				'<bean:write scope="session" name="organizacionId"/>',
				'Organizacion', 1);
	}
	...
	function informes(element) {
		...
		message = '<li><a href="javascript:informesCualitativos();">'
				+ '<vgcutil:message key="jsp.extension.informes.cualitativos" />'
				+ '</a></li>';
		</logic:equal>
		<logic:equal scope="session" name="activarInforme" property="hayEjecutivos" value="true">
		message = message + '<li><a href="javascript:informesEjecutivos();">'
				+ '<vgcutil:message key="jsp.extension.informes.ejecutivos" />'
				+ '</a></li>';
		</logic:equal>
		<logic:equal scope="session" name="activarInforme" property="hayEventos" value="true">
		message = message + '<li><a href="javascript:eventos();">'
				+ '<vgcutil:message key="jsp.extension.informes.eventos" />'
				+ '</a></li>';
		</logic:equal>
		<logic:equal scope="session" name="activarInforme" property="hayNoticias" value="true">
		message = message + '<li><a href="javascript:noticias();">'
				+ '<vgcutil:message key="jsp.extension.informes.noticias" />'
				+ '</a></li>';
		</logic:equal>
		</logic:notEmpty>
		message = message + '</ul>';
		...
		$('#dialog-titulo').html(
				'<vgcutil:message key="jsp.extension.titulo" />');
		...
		// ******************************
		//
		//var caja2 = $('<div><p>Esta es una segunda caja de di�logo...</p><p>En esta ocasi�n gener� en tiempo de ejecuci�n el DIV con Javascript y luego, sin llegar a mostrar el DIV en la p�gina, lo convierto en una caja de di�logo.</p></div>');
		//caja2.dialog(
		//{
		//	title: 'Edit Scope',
		//	modal : true,
	...
	function bancoProyectos() {
		window.location.href = "http://tyr.defensoria.gov.co/gestionideas?id="
				+ '<bean:write scope="session" name="organizacionId"/>';
	}
</script>

<form name="barraAreaForm" class="form-group">
	<input type="hidden" name="planId" /> <input type="hidden"
		name="nombrePlan" />
	...
	<vgcinterfaz:barraAreas width="100px" nombre="strategos">
		<!-- Organizaciones -->
		<logic:empty scope="session" name="activarOrganizacion">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="false"
				permisoId="ORGANIZACION" nombre="organizaciones"
				onclick="gestionarOrganizaciones();"
				urlImage="/paginas/strategos/imagenes/organizacion.png">
		...
		<logic:notEmpty scope="session" name="activarOrganizacion">
			<logic:notEmpty scope="session" name="activarOrganizacion"
				property="objeto">
				<logic:equal scope="session" name="activarOrganizacion"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="false"
						permisoId="ORGANIZACION" nombre="organizaciones"
						onclick="gestionarOrganizaciones();"
						urlImage="/paginas/strategos/imagenes/organizacion.png">
		...
		<logic:empty scope="session" name="activarIndicador">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
				permisoId="INDICADOR_RAIZ" nombre="indicadores"
				onclick="gestionarIndicadores();"
				urlImage="/paginas/strategos/imagenes/indicadores.gif">
		...
		<logic:notEmpty scope="session" name="activarIndicador">
			<logic:notEmpty scope="session" name="activarIndicador"
				property="objeto">
				<logic:equal scope="session" name="activarIndicador"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="INDICADOR_RAIZ" nombre="indicadores"
						onclick="gestionarIndicadores();"
		...
		<logic:empty scope="session" name="activarProblema">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
				permisoId="PROBLEMA" nombre="problemas"
				onclick="gestionarProblemas();"
				urlImage="/paginas/strategos/imagenes/problemas.png">
		...
		<logic:notEmpty scope="session" name="activarProblema">
			<logic:notEmpty scope="session" name="activarProblema"
				property="objeto">
				<logic:equal scope="session" name="activarProblema"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="PROBLEMA" nombre="problemas"
						onclick="gestionarProblemas();"
		...
		<!-- Banco Proyectos
		<vgcinterfaz:botonBarraAreas permisoId="" onclick="bancoProyectos();"
			nombre="riesgo" urlImage="/paginas/strategos/imagenes/portafolio.gif">
		...
		<logic:notEmpty scope="session" name="activarRiesgo">
			<logic:notEmpty scope="session" name="activarRiesgo"
				property="objeto">
				<logic:equal scope="session" name="activarRiesgo"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas permisoId=""
						onclick="gestionarRiesgo();" nombre="riesgo"
						urlImage="/paginas/strategos/imagenes/riesgo.gif">
    ...
    <!-- Plan -->
		<logic:empty scope="session" name="activarPlan">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
				permisoId="PLAN" nombre="planes" onclick="gestionarPlan();"
				urlImage="/paginas/strategos/imagenes/planes.gif">
		...
		<logic:notEmpty scope="session" name="activarPlan">
			<logic:notEmpty scope="session" name="activarPlan" property="objeto">
				<logic:equal scope="session" name="activarPlan"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="PLAN" nombre="planes" onclick="gestionarPlan();"
						urlImage="/paginas/strategos/imagenes/planes.gif">
		...
		<logic:empty scope="session" name="activarIniciativa">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
				permisoId="INICIATIVA" nombre="iniciativas"
				onclick="gestionarIniciativas();"
				urlImage="/paginas/strategos/imagenes/iniciativas.gif"
		...
		<logic:notEmpty scope="session" name="activarIniciativa">
			<logic:notEmpty scope="session" name="activarIniciativa"
				property="objeto">
				<logic:equal scope="session" name="activarIniciativa"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="INICIATIVA" nombre="iniciativas"
						onclick="gestionarIniciativas();"
		...
		<logic:empty scope="session" name="activarPresentacionEjecutiva">
			<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
				permisoId="VISTA" nombre="presentacionEjecutiva"
				onclick="gestionarPresentacionesEjecutiva();"
				urlImage="/paginas/strategos/imagenes/PresentacionEjecutiva.png">
		...
		<logic:notEmpty scope="session" name="activarPresentacionEjecutiva">
			<logic:notEmpty scope="session" name="activarPresentacionEjecutiva"
				property="objeto">
				<logic:equal scope="session" name="activarPresentacionEjecutiva"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="VISTA" nombre="presentacionEjecutiva"
						onclick="gestionarPresentacionesEjecutiva();"
		...
		<logic:empty scope="session" name="activarPortafolio">
			<vgcinterfaz:botonBarraAreas permisoId="PORTAFOLIO"
				onclick="gestionarPortafolios();" nombre="portafolios"
				urlImage="/paginas/strategos/imagenes/Portafolio.png">
		...
		<logic:notEmpty scope="session" name="activarPortafolio">
			<logic:notEmpty scope="session" name="activarPortafolio"
				property="objeto">
				<logic:equal scope="session" name="activarPortafolio"
					property="objeto.activo" value="true">
					<vgcinterfaz:botonBarraAreas permisoId=""
						onclick="gestionarPortafolios();" nombre="portafolios"
						urlImage="/paginas/strategos/imagenes/Portafolio.png">
		...
		<vgcinterfaz:botonBarraAreas permisoId="INSTRUMENTOS"
			onclick="gestionarInstrumentos();" nombre="instrumentos"
			urlImage="/paginas/strategos/imagenes/riesgo.gif">
    ...
    <!-- Reportes Graficos -->
		...
		<logic:notEmpty scope="session" name="activarInforme">
			<logic:equal scope="session" name="activarInforme"
				property="hayInformen" value="true">
				<logic:empty scope="session" name="activarVistaDatos">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="VISTA_DATOS" onclick="vistasDatos();"
						nombre="vistasDatos"
						urlImage="/paginas/strategos/imagenes/vistaDatos.gif">
				...
				<logic:notEmpty scope="session" name="activarVistaDatos">
					<logic:notEmpty scope="session" name="activarVistaDatos"
						property="objeto">
						<logic:equal scope="session" name="activarVistaDatos"
							property="objeto.activo" value="true">
							<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
								permisoId="VISTA_DATOS" onclick="vistasDatos();"
								nombre="vistasDatos"
				...
				<vgcinterfaz:botonBarraAreas permisoId=""
					onclick="informes(this.id);" nombre="informe"
					urlImage="/paginas/strategos/imagenes/informe.gif"
					agregarSeparador="true">
			...
			<!-- Vista de Datos -->
			<logic:notEqual scope="session" name="activarInforme"
				property="hayInformen" value="true">
				<logic:empty scope="session" name="activarVistaDatos">
					<vgcinterfaz:botonBarraAreas aplicaOrganizacion="true"
						permisoId="VISTA_DATOS" onclick="vistasDatos();"
		...
		<!-- Administracion -->
		<vgcinterfaz:botonBarraAreas permisoId="CONFIGURACION"
			nombre="adminus" onclick="gestionarAdministracion();"
			urlImage="/paginas/strategos/imagenes/administracion.gif">
		...
		<logic:notEmpty scope="session" name="enviroment">
			<logic:notEmpty scope="session" name="enviroment" property="tipo">
				<logic:equal scope="session" name="enviroment" property="tipo"
					value="enhance">
					<vgcinterfaz:botonBarraAreas nombre="Selector"
						onclick="selectores();"
						urlImage="/paginas/strategos/imagenes/administracion.gif">
            Selectores
          </vgcinterfaz:botonBarraAreas>
