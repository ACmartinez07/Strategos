<%@ taglib uri="/tags/vgc-util" prefix="vgcutil"%> <%@ taglib
uri="/tags/struts-html" prefix="html"%> <%@ taglib uri="/tags/struts-bean"
prefix="bean"%> <%@ taglib uri="/tags/struts-logic" prefix="logic"%> <%@ taglib
uri="/tags/vgc-interfaz" prefix="vgcinterfaz"%> <%@ page
errorPage="/paginas/comunes/errorJsp.jsp"%>
...
<script
  ...
  src="<html:rewrite  page='/paginas/strategos/explicaciones/Explicacion.js'/>"
></script>
  ...
  <vgcinterfaz:barraAreas width="100px" nombre="strategos">
    ...
    <logic:empty scope="session" name="activarOrganizacion">
      <vgcinterfaz:botonBarraAreas
        aplicaOrganizacion="false"
        permisoId="ORGANIZACION"
    ...
    <logic:notEmpty scope="session" name="activarOrganizacion">
      <logic:notEmpty
        scope="session"
        name="activarOrganizacion"
        property="objeto"
      >
        <logic:equal
          scope="session"
          name="activarOrganizacion"
          property="objeto.activo"
          value="true"
        >
          <vgcinterfaz:botonBarraAreas
            aplicaOrganizacion="false"
    ...
    <vgcinterfaz:botonBarraAreas
      permisoId=""
      onclick="bancoProyectos();"
      nombre="riesgo"
      urlImage="/paginas/strategos/imagenes/portafolio.gif"
    >
    ...
    <logic:notEmpty scope="session" name="activarPresentacionEjecutiva">
      <logic:notEmpty
        scope="session"
        name="activarPresentacionEjecutiva"
        property="objeto"
      >
        <logic:equal
          scope="session"
    ...
    <logic:empty scope="session" name="activarPortafolio">
      <vgcinterfaz:botonBarraAreas
        permisoId="PORTAFOLIO"
        onclick="gestionarPortafolios();"
        nombre="portafolios"
    ...
    <vgcinterfaz:botonBarraAreas
      permisoId="INSTRUMENTOS"
      onclick="gestionarInstrumentos();"
      nombre="instrumentos"
      urlImage="/paginas/strategos/imagenes/riesgo.gif"
    >
    ...
    <!-- Administracion -->
    <vgcinterfaz:botonBarraAreas
      permisoId="CONFIGURACION"
      nombre="adminus"
      onclick="gestionarAdministracion();"
