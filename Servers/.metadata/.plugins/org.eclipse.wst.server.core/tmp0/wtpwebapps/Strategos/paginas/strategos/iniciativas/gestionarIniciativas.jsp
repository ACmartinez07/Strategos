...
<script type="text/javascript">
	...
	function nuevoIniciativa() 
	{
		...
		abrirVentanaModal('<html:rewrite action="/iniciativas/crearIniciativa"/>' + url, "IniciativaAdd", 980, 750);
	}
	...
	function modificarIniciativa() 
	{
		...
		<logic:equal name="gestionarIniciativasForm" property="editarForma" value="true">			
			abrirVentanaModal('<html:rewrite action="/iniciativas/modificarIniciativa"/>?iniciativaId=' + document.gestionarIniciativasForm.seleccionadoId.value + url, "IniciativaEdit", 980, 750);
		</logic:equal>
		<logic:notEqual name="gestionarIniciativasForm" property="editarForma" value="true">
			<logic:equal name="gestionarIniciativasForm" property="verForma" value="true">				
				abrirVentanaModal('<html:rewrite action="/iniciativas/verIniciativa"/>?iniciativaId=' + document.gestionarIniciativasForm.seleccionadoId.value + url, "IniciativaEdit", 980, 750);
			</logic:equal>
		</logic:notEqual>
	}
