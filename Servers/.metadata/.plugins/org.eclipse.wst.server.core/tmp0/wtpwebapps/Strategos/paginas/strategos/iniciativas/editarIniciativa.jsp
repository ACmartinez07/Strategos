...
<tiles:insert definition="doc.modalLayout" flush="true">
	...
	<tiles:put name="body" type="String">
		...
		<script type="text/javascript">
			...
			function guardar() 
			{
				...
				if (validar(document.editarIniciativaForm)) 
				{
					...
					identificadorTiempoDeEspera = setTimeout(cerrarModal, 5000);
				}	
			...
			{	
				...
				window.document.editarIniciativaForm.submit();
				identificadorTiempoDeEspera = setTimeout(cerrarModal, 1000);
			}
		...
		<html:form action="/iniciativas/guardarIniciativa" focus="nombre">
			...
			<vgcinterfaz:contenedorForma width="910px" height="680px" bodyAlign="center" bodyValign="middle" bodyCellpadding="20">
				...
				<vgcinterfaz:contenedorPaneles height="550px" width="860px" nombre="editarIniciativa">
					...
					<vgcinterfaz:panelContenedor anchoPestana="105" nombre="datosBasicos">
						...
						<table class="bordeFichaDatos" cellpadding="4" cellspacing="10" border="0" >
							...
							<tr>
								...
								<td colspan="3"><html:text property="nombre" onkeypress="ejecutarPorDefecto(event)" size="87" disabled="<%= Boolean.parseBoolean(bloquearForma) %>" maxlength="250" styleClass="cuadroTexto" onkeyup="sincronizarCamposTexto(document.editarIniciativaForm.nombre, document.editarIniciativaForm.nombreLargo, 250, document.editarIniciativaForm.sincronizarNombres.checked)" /><input type="checkbox" name="sincronizarNombres" title="SincronizarNombres"></td>
							</tr>
							...
							<tr align="left">
								...
								<td align="left" colspan="1">	<html:radio property="tipoMedicion" value="0" disabled="<%= Boolean.parseBoolean(bloquearForma) %>"/><vgcutil:message key="jsp.editariniciativa.ficha.tipomedicion.enperiodo" /></td>
								<td align="left" colspan="2">	<html:radio property="tipoMedicion" value="1" disabled="<%= Boolean.parseBoolean(bloquearForma) %>"/><vgcutil:message key="jsp.editariniciativa.ficha.tipomedicion.alperiodo" /></td>
							...
							<tr>
								...
								<td colspan="1"><html:text property="responsableProyecto" onkeypress="ejecutarPorDefecto(event)" size="34" maxlength="150" styleClass="cuadroTexto" />
								
								<!-- Cargo -->
								<td align="left" colspan="1"><vgcutil:message key="jsp.editariniciativa.ficha.cargo" /></td>
								<td colspan="1"><html:text property="cargoResponsable" onkeypress="ejecutarPorDefecto(event)" size="34" maxlength="150" styleClass="cuadroTexto" />			
							</tr>						
							...
							<tr>
								...
								<td colspan="1"><html:text property="fuenteFinanciacion" onkeypress="ejecutarPorDefecto(event)" size="34" maxlength="150" styleClass="cuadroTexto" />
								
								<!-- Monto Financiamiento -->
								<td align="left" colspan="1"><vgcutil:message key="jsp.editariniciativa.ficha.monto" /></td>
								<td colspan="1"><html:text property="montoFinanciamiento" onkeypress="" size="34" maxlength="150" styleClass="cuadroTexto" />			
							</tr>	
							<!-- Campo enteEjecutor
							<tr>
