...
public class StrategosMedicionesHibernateSession extends StrategosHibernateSession implements StrategosMedicionesPersistenceSession
{
  public StrategosMedicionesHibernateSession(Session session)
  {
    super(session);
  }
  
  public StrategosMedicionesHibernateSession(StrategosHibernateSession parentSession)
  {
    super(parentSession);
  }
  
  public List<Medicion> getMedicionesPorFrecuencia(Long indicadorId, Long serieId, Integer anoInicial, Integer anoFinal, Integer periodoInicial, Integer periodoFinal, Byte frecuenciaRequerida, Byte frecuenciaOriginal, Boolean acumular, Boolean acumuladoPorPeriodo)
  {
    List<Medicion> mediciones = new ArrayList();
    List<Medicion> medicionesPorFrecuencia = new ArrayList();
    ...
    Medicion medicionSincronizada = new Medicion();
    ...
    if (mediciones != null)
    {
      for (Iterator<Medicion> i = mediciones.iterator(); (anoActual != anoFinal.intValue()) || (periodoFrecuenciaRequerida != periodoFinal.intValue()) || (contadorPeriodos <= multiploPeriodosFrecuencia);)
      {
        ...
        if ((medicion != null) && (medicion.getMedicionId().getAno().intValue() == anoActual) && (medicion.getMedicionId().getPeriodo().intValue() >= periodoInicioDesde[0]) && (medicion.getMedicionId().getPeriodo().intValue() <= periodoFinalHasta[0]))
        {
          ...
          if (medicion.getMedicionId().getPeriodo().intValue() == periodoFinalHasta[0])
          {
            ...
            medicionSincronizada = new Medicion(new MedicionPK(indicadorId, medicion.getMedicionId().getAno(), new Integer(periodoFrecuenciaRequerida), serieId), new Double(valorMedicion.doubleValue()));
        ...
        if ((!medicionInsertada) && (contadorPeriodos == multiploPeriodosFrecuencia))
        {
          ...
          for (Iterator<Medicion> iterAportes = medicionesPorFrecuencia.iterator(); iterAportes.hasNext();)
          {
          ...
          if (!existeMedicion)
          {
            medicionSincronizada = new Medicion(new MedicionPK(indicadorId, new Integer(anoActual), new Integer(periodoFrecuenciaRequerida), serieId), valorMedicion);
            medicionesPorFrecuencia.add(medicionSincronizada);
          }
        }
  ...
  public List<Medicion> getMedicionesPorFrecuencia(Long indicadorId, Long serieId, Boolean acumular, Boolean valorInicialCero, Byte tipoCorteIndicador, Byte frecuenciaOrigen, Byte frecuenciaDestino, Integer anoDesde, Integer periodoDesde, Integer anoHasta, Integer periodoHasta)
  {
    List<Medicion> medicionesResultado = new ArrayList();
    ...
    List<Medicion> mediciones = getMedicionesPeriodo(indicadorId, frecuenciaOrigen, serieId, anoDesde, anoHasta, new Integer(periodoDesdeInterno), new Integer(periodoHastaInterno));
    double total = 0.0D;
      ...
      for (Iterator<?> i = mediciones.iterator(); (anoActual != anoFinal.intValue()) || (periodoFrecuenciaRequerida != periodoFinal.intValue()) || (contadorPeriodos <= multiploPeriodosFrecuencia);)
      {
        ...
        if ((medicion != null) && (medicion.getMedicionId().getAno().intValue() == anoActual) && (medicion.getMedicionId().getPeriodo().intValue() >= periodoInicioDesde[0]) && (medicion.getMedicionId().getPeriodo().intValue() <= periodoFinalHasta[0]))
        {
          ...
          if (medicion.getMedicionId().getPeriodo().intValue() == periodoFinalHasta[0])
          {
            ...
            medicionSincronizada = new Medicion(new MedicionPK(indicadorId, medicion.getMedicionId().getAno(), new Integer(periodoFrecuenciaRequerida), serieId), new Double(valorMedicion));
        ...
        if ((!medicionInsertada) && (contadorPeriodos == multiploPeriodosFrecuencia))
        {
          medicionSincronizada = new Medicion(new MedicionPK(indicadorId, new Integer(anoActual), new Integer(periodoFrecuenciaRequerida), serieId), null);
  ...
  public List<Medicion> getMedicionesPeriodo(Long indicadorId, Long serieId, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal)
  {
    return getMedicionesPeriodo(indicadorId, null, serieId, anoInicio, anoFinal, periodoInicio, periodoFinal);
  }
  
  public List<Medicion> getMedicionesPeriodoExactas(Long indicadorId, Long serieId, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal)
  {
    ...
    List<Medicion> medicionesExistentes = query.list();
    
    return medicionesExistentes;
  }
  
  public List<Medicion> getMedicionesPeriodo(Long indicadorId, Byte frecuencia, Long serieId, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal)
  {
    List<Medicion> medicionesExistentes = getMedicionesPeriodoExactas(indicadorId, serieId, anoInicio, anoFinal, periodoInicio, periodoFinal);
  ...
  public List<Medicion> getMedicionesPeriodoPorFrecuencia(Long indicadorId, Byte frecuencia, Long serieId, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal, List<Medicion> medicionesExistentes)
  {
    List<Medicion> mediciones = new ArrayList();
  ...
  public List<Medicion> getMedicionesPeriodo(Long indicadorId, Byte frecuencia, Byte mesCierre, Long serieId, Boolean valorInicialCero, Byte corte, Byte tipoMedicion, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal)
  {
  ...
  public List<Medicion> getMedicionesAcumuladasPeriodo(Long indicadorId, Byte frecuencia, Byte mesCierre, Long serieId, Boolean valorInicialCero, Integer anoInicio, Integer anoFinal, Integer periodoInicio, Integer periodoFinal)
  {
    ...
    {
      Medicion medTemp = getPrimeraMedicion(indicadorId, serieId);
      if (medTemp != null) {
        if (anoInicio == null)
    ...
    {
      Medicion medTemp = getUltimaMedicion(indicadorId, serieId);
      if (medTemp != null)
      {
        if (anoFinal == null)
    ...
    {
      List<Medicion> medicionesExistentes = new ArrayList();
      ...
      for (Iterator<Medicion> m = medicionesExistentes.iterator(); m.hasNext();)
      {
    ...
    else if ((anoInicioInterno > 0) && (anoFinalInterno > 0) && (periodoInicioInterno > 0) && (periodoFinalInterno > 0))
    {
      ...
      if (valorInicialCero.booleanValue())
      {
        for (int ano = anoInicioInterno; ano <= anoFinalInterno; ano++)
        {
          ...
          List<Medicion> medicionesTemp = query.list();
  ...
  public Medicion getUltimaMedicion(Long indicadorId, Byte frecuencia, Byte mesCierre, Long serieId, Boolean valorInicialCero, Byte corte, Byte tipoMedicion)
  {
    List<Medicion> mediciones = null;
  ...
  public Medicion getMedicion(Long indicadorId, Long serieId, Integer ano, Integer periodo)
  {
    Criteria consulta = session.createCriteria(Medicion.class);
    ...
    List<Medicion> mediciones = consulta.list();
    
    if ((mediciones != null) && (mediciones.size() > 0)) {
      return (Medicion)mediciones.get(0);
    }
    return null;
  }
  
  public Medicion getUltimaMedicion(Long indicadorId, Long serieId)
  {
    Criteria consulta = session.createCriteria(Medicion.class);
  ...
  public Medicion getPrimeraMedicion(Long indicadorId, Long serieId)
  {
    Criteria consulta = session.createCriteria(Medicion.class);
  ...
  public int deleteMedicion(Medicion medicion) throws Throwable
  {
    int borrados = 0;
    try
    {
  ...
  public List<Medicion> getMedicionesIndicadores(List<Long> indicadoresIds, Long serieId, Integer anoInical, Integer anoFinal)
  {
    List<Medicion> mediciones = new ArrayList();
  ...
  public List<Medicion> getUltimasMedicionesIndicadores(List<Long> indicadoresIds, Long serieId)
  {
    List<Medicion> ultimasMediciones = new ArrayList();
  ...
  public List<Medicion> getMedicionesBySerie(List<Medicion> mediciones, Long indicadorId, Long serieId)
  {
    List<Medicion> med = new ArrayList();
  ...
  public Medicion getUltimaMedicion(List<Medicion> mediciones)
  {
    Medicion medicion = null;
    Integer ano = null;
  ...
  public double getUltimaMedicionAcumulada(List<Medicion> mediciones)
  {
    Medicion medicion = null;
    Integer ano = null;
  ...
  public Medicion getUltimaMedicionByAno(List<Medicion> mediciones, Integer ano)
  {
    Medicion medicion = null;
    Integer periodo = null;
  ...
  public Medicion getUltimaMedicionByAnoByPeriodo(List<Medicion> mediciones, Long indicadorId, Long serieId, Integer ano, Integer periodo, Boolean searDatabase)
  {
    Medicion medicion = null;
  ...
  public double getValorAcumulado(Long indicadorId, Long serieId) {
	...
	public List<Medicion> getMedicionesList(List<Long> indicadoresIds, Long serieId, Integer anoInicial, Integer mesInicio) {
		...
		if ((indicadoresIds != null) && (indicadoresIds.size() > 0))
	    {
			String sql = "select medicion from Medicion medicion where medicion.medicionId.indicadorId in (";
		      ...
		      sql =sql.substring(0, sql.length() - 2) + ") and medicion.medicionId.serieId = " + serieId;
			    
			  sql = sql + " and medicion.medicionId.ano =" + anoInicial;
			  sql = sql + " and medicion.medicionId.periodo = " + mesInicio;
			   
			   	    
			  sql = sql + " order by medicion.medicionId.indicadorId asc";
	    	 ...
	    	 String sql = "select medicion from Medicion medicion where ";
	    	
	    	  sql = sql + "medicion.medicionId.serieId = " + serieId;
